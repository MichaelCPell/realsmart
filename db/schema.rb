...
ActiveRecord::Schema.define(version: 20151030120710) do
  ...
  create_table "constitutes", force: :cascade do |t|
    t.integer  "demog.voter_id"
    t.integer  "geom.district_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "constitutes", ["demog.voter_id"], name: "index_demog.constitutes_on_demog.voter_id", using: :btree
  add_index "constitutes", ["geom.district_id"], name: "index_demog.constitutes_on_geom.district_id", using: :btree
  ...
  add_foreign_key "constitutes", "districts", column: "geom.district_id"
  add_foreign_key "constitutes", "voters", column: "demog.voter_id"
end
